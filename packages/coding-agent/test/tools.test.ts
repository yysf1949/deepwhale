...
describe('Sprint 0.2: 6 tools (v1.0 MVP) + D-30.1γ.4 (3 web tools) + D-30.2 (5 new tools) + D-30.3 (1 subagent) + D-30.4 (2 vision/tts) + D-31.1 (6 engineering tools)', () => {
  describe('ToolRegistry', () => {
    it('createDefaultRegistry registers 6 + 3 + 5 + 1 + 2 + 6 = 23 tools', () => {
