...
| **Prefix-cache 4 大机制** (D-20.2 P0-E) | ✅ done (固化) | `docs/design/prefix-cache-4-mechanisms.md` | 新增 `prefix-cache-4-mechanisms.test.ts` 8 it (D-20.2 联动测) | 4 机制: cache_hit_rate 字段 / canonicalizeSchema / cost_turn 算式 / Compaction 保 prefix |
